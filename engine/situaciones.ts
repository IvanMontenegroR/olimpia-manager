...
const PLANTILLAS: Plantilla[] = [
  {
    ...
    armar: (c, rng) => {
      ...
      return {
        s: {
          ...
          opciones: [
            { id: "prometer", etiqueta: "Prometerle que juega",
              detalle: "Se levanta él y el resto del banco se entera en diez minutos" },
        ...
        efectos: {
          prometer: { moralDe: { id: j.id, delta: 18 }, ambiente: -7,
            texto: `${j.apellido} se fue conforme. El resto del banco ya se enteró.` },
      ...
      s: {
        ...
        opciones: [
          ...
          { id: "nada", etiqueta: "Dejarlo pasar",
            detalle: "No gastás nada en esto. Sigue saliendo" },
        ],
      },
      efectos: {
        buscar: {
  ...
  // ------------------------------------------------------------ la cancha
  {
    ...
    armar: (c, rng) => ({
      ...
      efectos: {
        ...
        jugar: { condicionTodos: -8, ambiente: -1,
          texto: "Se intentó jugar en el barro y el equipo terminó fundido, pero entero." },
      },
    }),
  },
  {
  ...
  },
  {
    ...
    armar: () => ({
      ...
      efectos: {
        salir: { ambiente: 9, hinchada: 8, condicionTodos: -12,
          texto: "El plantel salió al portón. Se durmió a las dos, pero nadie se lo va a olvidar." },
